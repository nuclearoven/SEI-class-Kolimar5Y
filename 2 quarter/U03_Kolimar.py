...
def Timeline(df):
    ...
    USLaunches = df[df["Country"] == "USA"]
    RULaunches = df[df["Country"] == "Russia"]
    plt.hist(USLaunches["Year"], bins=65,color="b",histtype="step", label='USA')
    plt.hist(RULaunches["Year"], bins=65,color="r",histtype="step", label='Russia/USSR')
